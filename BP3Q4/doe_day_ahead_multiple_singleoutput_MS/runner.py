...
parser.add_argument('--model_id', type=str, required=False, default='DOE_TEST_MS', help='model id')  # Added MS
        ...
        for args.model in models_list:
            ...
            if args.is_training:
                for iter_time in range(args.itr):
                    ...
                    setting = '{}_{}_{}_{}_T:{}_ft{}_sl{}_ll{}_pl{}_il{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(
                        args.model_id,
                        args.model,
                        args.data,
                        data_name,
