...
parser.add_argument('--model_id', type=str, required=False, default='Transformer_VAE_LSTM_MS', help='model id')
...
parser.add_argument('--root_path', type=str,
                    default='../vae_lstm_transformer_multiple_singleoutput_MS/vae_lstm/dataset_individual',
...
parser.add_argument('--saved_model_path', type=str,
                    default='../vae_lstm_transformer_multiple_singleoutput_MS/vae_lstm/saved_models',
