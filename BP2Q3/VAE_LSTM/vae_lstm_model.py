...
class VAE_LSTM(nn.Module):
    def __init__(self, continuous_size, hidden_size, latent_size, output_size, device, num_layers=1):
        ...
        # Encoder layers
        self.lstm_enc = nn.LSTM(input_size=continuous_size,
        ...
        # Decoder layers
        self.lstm_dec = nn.LSTM(input_size=latent_size,
                                hidden_size=hidden_size,
                                num_layers=self.num_layers,
                                batch_first=True,
                                bidirectional=False)
