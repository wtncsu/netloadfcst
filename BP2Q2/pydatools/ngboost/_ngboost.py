...
from .distributions import Normal_Parameters
from .scoring_rules import CRPS



class _Multi_Output_Model:
    '''
...
class NGBoost:
    def __init__(self, base_learner,
        ...
        self._ensemble = [
            _Multi_Output_Model(base_learner, Dist_Params.num_parameters)
