...
mean = read_csv(args.mean, index_col=0).to_numpy().ravel()
std = read_csv(args.std, index_col=0).to_numpy().ravel()
target = read_csv(args.target, index_col=0).to_numpy().ravel()
