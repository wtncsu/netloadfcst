# -*- coding: utf-8 -*-
"""
Created on Fri Sep  3 18:46:16 2021

@author: jliang9

Baselines for point forecasting
"""

import pandas as pd
import numpy as np
from util import data_loader, mape, mae, LR_base, DT_base, SVM_base
from DL import LSTM_base, DNN_base, GRU_base
...
for i in range(len(names)):
    ...
    Train, Test = data[:(365+365+365+366)*24].reset_index(drop=True), data[(365+365+365+366)*24:].reset_index(drop=True)
...
Results.to_csv('../result/Results_large.csv',index=False)
Scores.to_csv('../result/Scores_large.csv',index=False)
