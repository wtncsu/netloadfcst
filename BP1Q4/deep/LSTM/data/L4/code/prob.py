...
names = ['Capital', 'Central', 'Dunwoody', 'Genese', 'Hudson', 'LongIsland', 'Milwood', 'NYC']
...
for i in range(len(names)):
    ...
    Train, Test = data[:(365+365+365+365)*24].reset_index(drop=True), data[(365+365+365+365)*24:].reset_index(drop=True)    
