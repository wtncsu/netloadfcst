...
aparser = ArgumentParser(
    description='Fit and predict dataset using decision tree'
)
...
train_pred_path = args.outdir / f'dt-train-pred-{output_name}.csv'
test_pred_path = args.outdir / f'dt-test-pred-{output_name}.csv'
timing_path = args.outdir / f'dt-timing-{output_name}.csv'
