...
train_pred_mean_path = args.outdir / f'bfdt-train-pred-mean-{output_name}.csv'
train_pred_std_path = args.outdir/ f'bfdt-train-pred-std-{output_name}.csv'
test_pred_mean_path = args.outdir / f'bfdt-test-pred-mean-{output_name}.csv'
test_pred_std_path = args.outdir / f'bfdt-test-pred-std-{output_name}.csv'
timing_path = args.outdir / f'bfdt-timing-{output_name}.csv'

df_train_features = read_csv(train_features_path, index_col='time')
df_train_target = read_csv(train_target_path, index_col='time')
df_test_features = read_csv(test_features_path, index_col='time')
...
base_learner = Fuzzy_Decision_Tree_Regressor(
    ...
    batch_size=int(configs['base_learner']['batch_size']),
    n_epochs=int(configs['base_learner']['n_epochs'])
)
